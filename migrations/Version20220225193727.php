 ...
 */
final class Version20220225193727 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD adr VARCHAR(255) DEFAULT NULL');
    }
